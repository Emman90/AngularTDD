...
describe("The Address Book App", function(){
    describe("the contact service", function(){
       ...
       it("should have a contact property, an array", function(){
    ...
    describe("the contact controller", function(){
       beforeEach(function(){
        ...
        it("should store an array on contacts in scope", function(){
    ...
    describe("the proper filter", function(){
        ...
        it("should proper case a string", function(){
           expect(proper("thembani fubesi")).to.equal("Thembani Fubesi");
        });
